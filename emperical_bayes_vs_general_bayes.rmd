...
# --------- 1D normalization helper (for proper density) ---------
# Given log-unnormalized f(x), return normalized density on grid xs
# Handles uniform or non-uniform grids robustly.
...
# convenience wrappers for EB / GBI
